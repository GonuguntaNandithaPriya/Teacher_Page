                    ...
                    children: <Widget>[
                      menuCard(context),
                       Row(
                         children: [
                           Padding(
                             padding: const EdgeInsets.fromLTRB(194.0,15.0,0.0,0.0),
                             child: Align(
                              alignment: Alignment.topLeft,
                            child:Text("Sessions:",style: TextStyle(color: Color.fromARGB(255, 250, 152, 5),fontWeight:FontWeight.bold))),
                      ),
                       Padding(
                            padding: const EdgeInsets.fromLTRB(1180.0,20.0,0.0,0.0),
                            child: Align(
                              alignment: Alignment.topLeft,
                              child: TextButton(onPressed:(){print('VIEW ALL');},child: Text("View All",style: TextStyle(color: Color.fromARGB(255, 6,38, 145),fontWeight:FontWeight.bold)),),
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) =>
                      ...
                      Row(
                        children: [
                          Padding(
                            padding: const EdgeInsets.fromLTRB(194.0,20.0,0.0,0.0),
                            child: Align(
                              alignment: Alignment.topLeft,
                            child:Text("Tasks Batches",style: TextStyle(color: Color.fromARGB(255, 250, 152, 5),fontWeight:FontWeight.bold))),
                          ),
                          Padding(
                            padding: const EdgeInsets.fromLTRB(100.0,20.0,0.0,0.0),
                            child: Align(
                              alignment: Alignment.topLeft,
                            child: TextButton.icon(onPressed:(){print('VIEW ALL');},icon: const Icon(Icons.arrow_drop_down_circle),label:Text("View All",style: TextStyle(color: Color.fromARGB(255, 6,38, 145),fontWeight:FontWeight.bold))),
                            ))],
                      ),
                      Padding(
